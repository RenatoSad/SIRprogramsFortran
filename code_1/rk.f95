 ...
 implicit none
  ...
  integer(i4b) :: p1,p2,pp2,p3,p4,p5,p6,si,ii,ri ,j
...
miu=(183._wp/10000._wp)*dfloat(p3) !tasa de nacimientos
om = pi / 365._wp 
...
write(10 + j,'(8ES24.13E3)') t/365,so,io,ro,so+io+ro        

do tau=1,ntotal
   t = t + det
   
 !runge-kutta 4th order 
call eqs1(ks1,ki1,kr1,so,io,ro,beta,kappa,kappa2,miu,det,j,t0,om)        
   
  s = so + ks1/2._wp
  i = io + ki1/2._wp
  r = ro + kr1/2._wp
  
call eqs1(ks2,ki2,kr2,s,i,r,beta,kappa,kappa2,miu,det,j,t0 + det/two,om)        

  s = so + ks2/2._wp
  i = io + ki2/2._wp
  r = ro + kr2/2._wp
  
call eqs1(ks3,ki3,kr3,s,i,r,beta,kappa,kappa2,miu,det,j,t0 + det/two,om)        

  s = so + ks3
  i = io + ki3
  r = ro + kr3

call eqs1(ks4,ki4,kr4,s,i,r,beta,kappa,kappa2,miu,det,j,t0,om)        
