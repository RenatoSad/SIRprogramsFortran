...
plt.subplot(111)
plt.plot(f40[:,0],f40[:,1],'navy',marker='o',markevery=200,markersize=10,label=r'$S(\tau)$', linewidth=2.5)
plt.plot(f40[:,0],f40[:,2],'orange',marker='o',markevery=200,markersize=10,label=r'$I(\tau)$', linewidth=2.5)
plt.plot(f40[:,0],f40[:,3],'red',marker='o',markevery=200,markersize=10,label=r'$R(\tau)$', linewidth=2.5)
plt.plot(f40[:,0],f40[:,4],'green',marker='o',markevery=200,markersize=10,label=r'$N(\tau)$', linewidth=2.5)

#plt.xlim(xmax = 1, xmin = 0)
#plt.yticks(np.arange(-200.0, -800-1, -200))
plt.ylabel('Modelo 5',fontsize=(40))
