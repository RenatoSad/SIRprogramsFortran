...
fig.text(0.04, 0.51, r'$I(t)$', ha='center',fontsize=(30))
...
plt.subplot(111)
plt.plot(f13[:,0],f13[:,1],'navy',label=r'$Classic$', linewidth=2.5)
plt.plot(f14[:,0],f14[:,1],'orange',label=r'$Exponential$', linewidth=2.5)
#plt.plot(f15[:,0],f15[:,2],'red',label=r'$Lineal$', linewidth=2.5)
#plt.plot(f16[:,0],f16[:,2],'green',label=r'$Lineal2$', linewidth=2.5)
