...
subroutine randomcoefci(c0,c1,c2,c3,c4,c5)
use my_prec, only: i4b,wp => dp ! for double precission constants

real(wp), intent(out) :: c0,c1,c2,c3,c4,c5
real(wp) :: ur0,ur1,ur2,ur3,ur4,ur5


 ur0 = rand_unif(0.0_wp,1.0_wp)
 if (ur0<0.5_wp) then
    c0 = 0.0_wp
    else
  c0 = 1.0_wp
 endif
ur1 = rand_unif(0.0_wp,1.0_wp)
if (ur1<0.5_wp) then
   c1 = 0.0_wp
   else
   c1 = 1.0_wp
endif
ur2 = rand_unif(0.0_wp,1.0_wp)
if (ur2<0.5_wp) then
   c2 = 0.0_wp
   else
   c2 = 1.0_wp
endif
ur3 = rand_unif(0.0_wp,1.0_wp)
if (ur3<0.5_wp) then
   c3 = 0.0_wp
   else
   c3 = 1.0_wp
endif
ur4 = rand_unif(0.0_wp,1.0_wp)
if (ur4<0.5_wp) then
   c4 = 0.0_wp
   else
   c4 = 1.0_wp
endif
ur5 = rand_unif(0.0_wp,1.0_wp)
if (ur5<0.5_wp) then
   c5 = 0.0_wp
   else
   c5 = 1.0_wp
...
!  if (c0 == 0.0_wp .and. c1 == 0.0_wp .and. c2 == 0.0_wp .and. c3 == 0.0_wp .and. c4 == 0.0_wp .and. c5 == 0.0_wp) then
!   c0 = 1.0_wp
!   endif
! 
!  if (c0 == 0.0_wp .and. c1 == 1.0_wp .and. c2 == 0.0_wp .and. c3 == 0.0_wp .and. c4 == 0.0_wp .and. c5 == 0.0_wp) then
!   c0 = 1.0_wp
!   endif
!   
!   if (c0 == 0.0_wp .and. c1 == 0.0_wp .and. c2 == 1.0_wp .and. c3 == 0.0_wp .and. c4 == 0.0_wp .and. c5 == 0.0_wp) then
!   c0 = 1.0_wp
!   endif
!   
!   if (c0 == 0.0_wp .and. c1 == 0.0_wp .and. c2 == 0.0_wp .and. c3 == 1.0_wp .and. c4 == 0.0_wp .and. c5 == 0.0_wp) then
!   c0 = 1.0_wp
!   endif
!   
!   if (c0 == 0.0_wp .and. c1 == 0.0_wp .and. c2 == 0.0_wp .and. c3 == 0.0_wp .and. c4 == 1.0_wp .and. c5 == 0.0_wp) then
!   c0 = 1.0_wp
!   endif
! 
!   if (c0 == 0.0_wp .and. c1 == 0.0_wp .and. c2 == 0.0_wp .and. c3 == 0.0_wp .and. c4 == 0.0_wp .and. c5 == 1.0_wp) then
!   c0 = 1.0_wp
!   endif
